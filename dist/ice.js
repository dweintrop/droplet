  ...
  define('ice-coffee',['ice-helper', 'ice-model', 'ice-parser', 'coffee-script'], function(helper, model, parser, CoffeeScript) {
    ...
    CoffeeScriptTranspiler = (function() {
      ...
      CoffeeScriptTranspiler.prototype.mark = function(node, depth, precedence, wrappingParen, indentDepth) {
        var arg, bounds, childName, condition, errorSocket, expr, fakeBlock, firstBounds, indent, index, infix, line, lines, methodname, object, param, property, secondBounds, shouldBeOneLine, switchCase, textLine, trueIndentDepth, unrecognized, _i, _j, _k, _l, _len, _len1, _len10, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _results, _results1, _results2, _results3, _results4, _s, _t;
        switch (node.nodeType()) {
          ...
          case 'Call':
            if (node.variable != null) {
              ...
              if ((methodname != null ? methodname.length : void 0) > 1 && (node != null ? (_ref9 = node.variable) != null ? _ref9.locationData : void 0 : void 0) && node.variable.locationData.first_column === node.variable.locationData.last_column && node.variable.locationData.first_line === node.variable.locationData.last_line) {
                unrecognized = false;
              }
              if (unrecognized || ((_ref10 = node.variable.base) != null ? _ref10.nodeType() : void 0) !== 'Literal') {
                this.addSocketAndMark(node.variable, depth + 1, 0, indentDepth);
              } else if (((_ref11 = node.variable.properties) != null ? _ref11.length : void 0) > 0) {
            ...
            if (!node["do"]) {
              _ref12 = node.args;
              _results2 = [];
              for (index = _m = 0, _len3 = _ref12.length; _m < _len3; index = ++_m) {
                arg = _ref12[index];
                precedence = 0;
    ...
    hook('populate', 0, function() {
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        ...
        _results.push((function(paletteGroup) {
          var clickHandler, data, event, paletteGroupHeader, _j, _k, _len1, _len2, _ref1, _ref2, _results1;
          if (i % 2 === 0) {
